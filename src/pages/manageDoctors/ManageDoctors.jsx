                ...
                <div class="md:w-11/12 lg:w-10/12 mx-auto">
                                    ...
                                    <table class="min-w-full">
                                        <thead class="border-b">
                                            <tr className='bg-[#b1c798]'>
                                                ...
                                                <th scope="col" class="text-base font-medium text-white px-6 py-4 text-left">Avatar</th>
                                                ...
                                                <th scope="col" class="text-base font-medium text-white px-6 py-4 text-left">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr class="bg-white border-b">
                                                ...
                                                <td class="text-sm text-gray-900 px-6 py-4 whitespace-nowrap"><div class="flex-shrink-0 h-10 w-10">
                    ...
                    <div class="grid grid-cols-1 md:hidden h-64 mt-6 ">
                        <div class="bg-white rounded-sm shadow-lg px-6 py-10 mb-4 text-center">
                            ...
                            <p className='mt-4 bg-red-100 px-3 py-2 w-6/12 mx-auto'>
                                <a href="#" class=" text-red-600 hover:text-red-900">Delete</a>
                            </p>
                        </div>
